...
handler do |job|
  if job.eql?('list new open people')
    ...
    SendJobDataToSqs.call({ "klass" => "Sync", "method" => "update_status", "params" => { "status" => "accepted", "programs" => "2", "for_filter" => "opportunities" } })
  elsif job.eql?('list new in progress applications and update GT opportunities')
    SendJobDataToSqs.call({ "klass" => "Sync", "method" => "update_status", "params" => { "status" => "in_progress", "programs" => "2", "for_filter" => "opportunities" } })
  elsif job.eql?('list new approved applications and update GT opportunities')
    SendJobDataToSqs.call({ "klass" => "Sync", "method" => "update_status", "params" => { "status" => "approved", "programs" => "2", "for_filter" => "opportunities" } })
  elsif job.eql?('list new realized applications and update GT opportunities')
    ...
    SendJobDataToSqs.call({ "klass" => "Sync", "method" => "update_status", "params" => { "status" => "accepted", "programs" => "5", "for_filter" => "opportunities" } })
  elsif job.eql?('list new in progress applications and update GE opportunities')
    SendJobDataToSqs.call({ "klass" => "Sync", "method" => "update_status", "params" => { "status" => "in_progress", "programs" => "5", "for_filter" => "opportunities" } })
  elsif job.eql?('list new approved applications and update GE opportunities')
    SendJobDataToSqs.call({ "klass" => "Sync", "method" => "update_status", "params" => { "status" => "approved", "programs" => "5", "for_filter" => "opportunities" } })
  elsif job.eql?('list new realized applications and update GE opportunities')
    SendJobDataToSqs.call({ "klass" => "Sync", "method" => "update_status", "params" => { "status" => "realized", "programs" => "5", "for_filter" => "opportunities" } })
  elsif job.eql?('list new completed applications and update GE opportunities')
    SendJobDataToSqs.call({ "klass" => "Sync", "method" => "update_status", "params" => { "status" => "completed", "programs" => "5", "for_filter" => "opportunities" } })
...
every(8.hours, 'list new open opportunities')

every(4.hours, 'list new open applications and update people')
every(2.hours, 'list new accepted applications and update people')
every(3.hours, 'list new in progress applications and update people')
every(5.hours, 'list new approved applications and update people')
every(8.hours, 'list new realized applications and update people')
every(9.hours, 'list new completed applications and update people')

every(4.hours, 'list new open applications and update GT people')
every(2.hours, 'list new accepted applications and update GT people')
every(3.hours, 'list new in progress applications and update GT people')
every(5.hours, 'list new approved applications and update GT people')
every(8.hours, 'list new realized applications and update GT people')
every(9.hours, 'list new completed applications and update GT people')

every(4.hours, 'list new open applications and update GE people')
every(2.hours, 'list new accepted applications and update GE people')
every(3.hours, 'list new in progress applications and update GE people')
every(5.hours, 'list new approved applications and update GE people')
every(8.hours, 'list new realized applications and update GE people')
every(9.hours, 'list new completed applications and update GE people')

every(4.hours, 'list new open applications and update GV opportunities')
every(2.hours, 'list new accepted applications and update GV opportunities')
every(3.hours, 'list new in progress applications and update GV opportunities')
every(5.hours, 'list new approved applications and update GV opportunities')
every(8.hours, 'list new realized applications and update GV opportunities')
every(9.hours, 'list new completed applications and update GV opportunities')

every(4.hours, 'list new open applications and update GT opportunities')
every(2.hours, 'list new accepted applications and update GT opportunities')
every(3.hours, 'list new in progress applications and update GT opportunities')
every(5.hours, 'list new approved applications and update GT opportunities')
every(8.hours, 'list new realized applications and update GT opportunities')
every(9.hours, 'list new completed applications and update GT opportunities')

every(4.hours, 'list new open applications and update GE opportunities')
every(2.hours, 'list new accepted applications and update GE opportunities')
every(3.hours, 'list new in progress applications and update GE opportunities')
every(5.hours, 'list new approved applications and update GE opportunities')
every(8.hours, 'list new realized applications and update GE opportunities')
every(9.hours, 'list new completed applications and update GE opportunities')
