...
server 'ec2-54-215-251-199.us-west-1.compute.amazonaws.com', port: 22, user: 'ubuntu', rolse: [:web, :app, :db]
server 'ec2-54-183-99-215.us-west-1.compute.amazonaws.com', port: 22, user: 'ubuntu', rolse: [:web, :app, :db]
